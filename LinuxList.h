...
static void __list_add(struct list_head* pos,
...
#else
extern void __list_add(struct list_head* pos,
                       struct list_head* prev,
                       struct list_head* next);
#endif
 ...
 * @pos: new entry to be added
 * @head: list head to add it after
 *
 * Insert a new entry after the specified head.
 * This is good for implementing stacks.
 */
static void list_add(struct list_head* pos, struct list_head* head)
{
    __list_add(pos, head, head->next);
}
 ...
 */
static void list_add_tail(struct list_head* pos, struct list_head* head)
{
    __list_add(pos, head->prev, head);
}
...
static void hlist_move_list(struct hlist_head* old,
                            struct hlist_head* pos)
{
    pos->first = old->first;
    if(pos->first)
    {
        pos->first->pprev = &pos->first;
    }
    old->first = NULL;
}
